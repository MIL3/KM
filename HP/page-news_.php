...
<html lang="ja" xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml">
  <head>
    ...
    <link rel="start" href="http://sohmatestsite.ciao.jp/test2/news/">

	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/common/js/page.js"></script>
    <!-- Open Graph Protocol -->
...
<!-- rightArea -->
<div id="rightArea">
	<p id="pageLogo"><a href="/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/logo.gif" width="100" height="106"  alt="医療法人 保田窪会 小林研究室"></a></p>
	<nav id="menu">
		<ul class="listBlock">
			<li class="current"><a href="/news/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/menu1.png" width="89" height="29"  alt="お知らせ"></a></li>
			<li><a href="/information/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/menu2.png" width="114" height="29"  alt="当院のご案内"></a></li>
			<li><a href="/facilities/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/menu3.png" width="90" height="29"  alt="施設情報"></a></li>
			<li><a href="/medical/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/menu4.png" width="112" height="29"  alt="診療のご案内"></a></li>
			<li><a href="/hospitalized/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/menu5.png" width="145" height="29"  alt="入院・面会について"></a></li>

			<li><a href="/access/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/menu7.png" width="108" height="29"  alt="交通アクセス"></a></li>
		</ul>
	</nav>
...
<div id="mainArea"><div id="mainAreaInner">
	...
	<div id="mainContentsArea" class="printNews">
		<header class="title1Area" id="pageNews">
			...
			<p id="title1Eng"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/news_title1_eng.gif" width="29" height="8"  alt="news"></p>
		</header>
		<section class="contentsMain cType1 newsArea">

              <article class="newsArticle clearfix" id="entry-26">
	<div class="newsArticleLeft">
    <time datetime="2016-10-01T09:11:20+09:00" itemprop="datePublished"><span>2016年12月29日</span></time>
	</div>
	<div class="newsArticleRight">
		<h2>17:29　TVで紹介されました</h2>
		<div class="newsBox">
    		<p>日本テレビ　 「日テレNEWS24」不可能を可能に…夢を叶える技術、続々と</p>
		</div>
	</div>
</article>
      ...
      <article class="newsArticle clearfix" id="entry-26">
	<div class="newsArticleLeft">
    <time datetime="2016-10-01T09:11:20+09:00" itemprop="datePublished"><span>2016年12月17日</span></time>
	</div>
	<div class="newsArticleRight">
		<h2>18:56～22:54　TVで紹介されました</h2>
		<div class="newsBox">
    		<p>テレビ朝日　 「スゴ～イデスネ視察団」4時間スペシャルに出演しました．</p>
		</div>
	</div>
</article>
 ...
 <article class="newsArticle clearfix" id="entry-26">
	<div class="newsArticleLeft">
    <time datetime="2016-10-01T09:11:20+09:00" itemprop="datePublished"><span>2016年12月9日</span></time>
	</div>
	<div class="newsArticleRight">
		<h2> 『日本証券新聞（東京）』　　新聞に掲載されました</h2>
		<div class="newsBox">
    		<p>エージーピー　ウェアラブル型ロボット販売へ</p>
		</div>
	</div>
</article>
...
<div id="visualArea">
	<div class="visualPict">
		<ul class="listBlock">
			<li><img src="<?php echo esc_url(get_template_directory_uri()); ?>/common/images/news_visual.jpg" width="900" height="900"></li>
		</ul>
	</div>
</div>
<!-- /visualArea -->
